 ...
 * @version    CVS: $Id: Storage.php,v 1.13 2007/05/06 08:28:17 hholzgra Exp $
...
class CodeGen_Drizzle_Element_Storage
  extends CodeGen_Drizzle_Element
{
    ...
    {
      return "DRIZZLE_STORAGE_ENGINE_PLUGIN";
    }
...
";
      ...
      $code.= "struct st_drizzle_storage_engine {$lowname}_descriptor=\n";
      $code.= "{ DRIZZLE_HANDLERTON_INTERFACE_VERSION };\n";
